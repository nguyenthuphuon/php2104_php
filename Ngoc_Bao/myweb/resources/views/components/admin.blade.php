        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}" class="text-sm text-gray-700 underline">Log out <i class="fas fa-sign-out-alt"></i></a></li>
              <div class="ml-1">

        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="{{ route('adminproducts.index') }}"><img class="main-logo" src="/themes/nalika/img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/themes/nalika/img/contact/1.jpg" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/themes/nalika/img/contact/4.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/themes/nalika/img/contact/3.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/themes/nalika/img/contact/2.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="{{ route('adminproducts.index') }}">Product List</a></li>
							...
							<div class="row">
								<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
									...
									<ul id="single-product-tab">
										<li class="active">
											<a href="#single-tab1"><img src="{{ $product->image }}" alt="" /></a>
										</li>
										<li>
											<a href="#single-tab2"><img src="{{ $product->image }}" alt="" /></a>
										</li>
										<li>
											<a href="#single-tab3"><img src="{{ $product->image }}" alt="" /></a>
										</li>
										<li>
											<a href="#single-tab4"><img src="{{ $product->image }}" alt="" /></a>
										</li>
									</ul>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
									<div class="single-product-details res-pro-tb">
										...
										<div class="single-pro-price">
											<span class="single-regular">{{ $product->price }}.000</span><span class="single-old"><del>{{ $product->price_off }}</del></span>
										</div>
											...
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<div class="review-content-section">
														<p>{{ $product->description }}</p>
														<p class="pro-b-0">{{ $product->description }}</p>
													</div>
												</div>
											</div>
										</div>

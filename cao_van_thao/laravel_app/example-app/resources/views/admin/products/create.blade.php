																	...
																	<ul class="mobile-menu-nav">
																			<li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
																					<ul class="collapse dropdown-header-top">
																							...
																							<li><a href="{{ route('adminproducts.create') }}">Product Edit</a></li>
																					...
																					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																									...
																									<div class="row">
																											<div class="col-lg-4">
																													<div class="pro-edt-img">
																															<img src="/themes/nalika/img/new-product/5-small.jpg" alt="" />
																													</div>
																											</div>
																											<div class="col-lg-8">
																													<div class="row">
																						...
																						<i class="fa fa-times" aria-hidden="true"></i>
																									...
																									<div class="row">
																											<div class="col-lg-4">
																													<div class="pro-edt-img">
																															<img src="/themes/nalika/img/new-product/6-small.jpg" alt="" />
																													</div>
																											</div>
																											<div class="col-lg-8">
																													<div class="row">
																									...
																									<div class="row">
																											<div class="col-lg-4">
																													<div class="pro-edt-img mg-b-0">
																															<img src="/themes/nalika/img/new-product/7-small.jpg" alt="" />
																													</div>
																											</div>
																											<div class="col-lg-8">
																													<div class="row">
